...
# Generates the Python SDK from Storefront.Api's live OpenAPI document.
...
echo "=========================================="
echo "Generating OrderEazi Commerce API Python SDK"
echo "=========================================="
...
npx --yes @openapitools/openapi-generator-cli generate \
    ...
    -g python \
    -o "${OUTPUT_DIR}" \
    --additional-properties=packageName=ordereazi_commerce_api,projectName=ordereazi-commerce-sdk,packageVersion="${PACKAGE_VERSION}"
...
node "${SDK_DIR}/../scripts/apply-package-metadata.js" python "${OUTPUT_DIR}"

echo "✓ Python SDK generated in ${OUTPUT_DIR}"
echo ""
echo "To build/install locally:"
echo "  cd ${OUTPUT_DIR}"
echo "  pip install ."
